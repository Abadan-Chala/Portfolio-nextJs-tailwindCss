    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <h3 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <a href="/sample-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-50 flex items-center gap-2'>my resume <Image src={assets.download_icon} alt='' className='w-4'/></a>
        </div>
    </div>
  )
}
